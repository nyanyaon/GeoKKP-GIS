...
<qgis maxScale="0" simplifyLocal="1" simplifyMaxScale="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" version="3.20.3-Odense" styleCategories="AllStyleCategories" simplifyDrawingHints="0" readOnly="0" labelsEnabled="1" minScale="100000000">
  ...
  <temporal startField="" durationUnit="min" accumulate="0" endField="" startExpression="" endExpression="" mode="0" enabled="0" durationField="" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="Regular" fontSize="10" fontItalic="0" fontLetterSpacing="0" fontWeight="50" capitalization="0" fontUnderline="0" fieldName="label" allowHtml="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textColor="50,50,50,255" useSubstitutions="0" isExpression="0" blendMode="0" fontSizeUnit="Point" previewBkgrdColor="255,255,255,255" fontKerning="1" textOrientation="horizontal" fontWordSpacing="0" textOpacity="1" fontFamily="Arial" fontStrikeout="0" multilineHeight="1" legendString="Aa">
        <families/>
        <text-buffer bufferDraw="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferOpacity="1" bufferColor="250,250,250,255" bufferBlendMode="0" bufferSizeUnits="MM" bufferSize="1"/>
        <text-mask maskSizeUnits="MM" maskSize="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskJoinStyle="128" maskOpacity="1" maskedSymbolLayers="" maskType="0"/>
        <background shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeBorderWidthUnit="Point" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeType="0" shapeOffsetY="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeRotationType="0" shapeBorderColor="128,128,128,255" shapeDraw="0" shapeOffsetUnit="Point" shapeSizeX="0" shapeJoinStyle="64" shapeSizeUnit="Point" shapeOpacity="1" shapeSizeY="0" shapeBorderWidth="0" shapeBlendMode="0" shapeSizeType="0" shapeRadiiUnit="Point" shapeRotation="0" shapeSVGFile="">
        ...
        <shadow shadowRadiusAlphaOnly="0" shadowBlendMode="6" shadowRadiusUnit="MM" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetUnit="MM" shadowDraw="0" shadowRadius="1.5" shadowUnder="0" shadowOffsetDist="1" shadowOffsetGlobal="1" shadowOpacity="0.69999999999999996" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowScale="100" shadowOffsetAngle="135" shadowColor="0,0,0,255"/>
        <dd_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
