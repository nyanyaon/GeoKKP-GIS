...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), '../ui/layout_gu.ui'))
...
class LayoutGUDialog(QtWidgets.QDialog, FORM_CLASS):
    ...
    def write_settings(self):
        ...
        self.project.writeEntry('GeoKKP', "gu_nama_kecamatan", self.gu_nama_kecamatan.text())
        ...
        self.project.writeEntry('GeoKKP', "gu_pu_surat_tugas", self.gu_pu_surat_tugas.text())
