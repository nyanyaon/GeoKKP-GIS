...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), '../../../ui/workpanel/tab_lokasi.ui'))
...
class TabLokasi(QtWidgets.QWidget, FORM_CLASS):
    ...
    def populate_provinsi(self, kantor_id, tipe_kantor_id):
        ...
        if kantor_id in self.provinsi_by_kantor.keys() and self.provinsi_by_kantor[kantor_id]:
    ...
    def populate_kabupaten(self, kantor_id, tipe_kantor_id, provinsi_id):
        ...
        if provinsi_id in self.kabupaten_by_provinsi.keys() and self.kabupaten_by_provinsi[provinsi_id]:
    ...
    def populate_kecamatan(self, kantor_id, tipe_kantor_id, kabupaten_id):
        ...
        if kabupaten_id in self.kecamatan_by_kabupaten.keys() and self.kecamatan_by_kabupaten[kabupaten_id]:
    ...
    def populate_kelurahan(self, kantor_id, tipe_kantor_id, kecamatan_id):
        ...
        if kecamatan_id in self.kelurahan_by_kecamatan.keys() and self.kelurahan_by_kecamatan[kecamatan_id]:
    ...
    def provinsi_changed(self, index):
        ...
        self.populate_kabupaten(self.current_kantor_id, self.current_tipe_kantor_id, current_provinsi_id)
    ...
    def kabupaten_changed(self, index):
        ...
        self.populate_kecamatan(self.current_kantor_id, self.current_tipe_kantor_id, current_kabupaten_id)
    ...
    def kecamatan_changed(self, index):
        ...
        self.populate_kelurahan(self.current_kantor_id, self.current_tipe_kantor_id, current_kecamatan_id)
